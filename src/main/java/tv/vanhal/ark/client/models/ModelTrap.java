package tv.vanhal.ark.client.models;
...
//This model was taken from openblocks
//https://github.com/OpenMods/OpenBlocks/blob/master/src/main/java/openblocks/client/model/ModelBearTrap.java
public class ModelTrap extends ModelBase {
	...
	public void renderAll(boolean shut, int ticksSinceOpened) {
		...
		if (!shut) {
			rot = Math.max(0.0f, 1.4f - ((float)ticksSinceOpened / TileEntityTrap.OPENING_ANIMATION_TIME));
		}
